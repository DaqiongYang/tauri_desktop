...
fn get_conn() -> Connection {
    let conn = Connection::open("../../palm.db");
    match conn {
...
fn create(sql_text: &str) -> super::Response<String> {
    ...
    match res {
        Ok(_) => super::Response::new(1, "创建成功".to_string(), "创建成功".to_string()),
        Err(err) => super::Response::new(0, "创建失败".to_string(), err.to_string()),
    }
}
...
// 查询连接列表
#[tauri::command]
pub async fn get_links() -> super::Response<Option<Vec<Link>>> {
    let data = query_links();
    match data {
        Ok(data) => super::Response::new(1, "查询成功".to_string(), Some(data)),
        Err(_) => super::Response::new(0, "查询失败".to_string(), None),
    }
}
...
) -> super::Response<Option<Vec<History>>> {
...
pub fn save_link(data: Link) -> super::Response<String> {
    ...
    match res {
        Ok(_) => super::Response::new(1, "保存成功".to_string(), "保存成功".to_string()),
        Err(e) => super::Response::new(0, "保存失败".to_string(), e.to_string()),
    }
}
...
pub fn delete(id: &str, tb_mark: u8) -> super::Response<String> {
    ...
    match res {
        Ok(_) => super::Response::new(1, "删除成功".to_string(), "".to_string()),
        Err(e) => super::Response::new(0, "删除失败".to_string(), e.to_string()),
    }
}
